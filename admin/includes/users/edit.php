...
$proj = $bdd->query("SELECT * FROM admin_login WHERE PKNoMembre=" . $_GET['id']);
$projet = $proj->fetch();
$pageName = "users";
?>
    ...
    <div class="block big">
        ...
        <div class="block_cont">
            ...
            <div class="form_row url" style="float:left; margin-right: 15px;">
                ...
                <input type="text" required="required" placeholder="adresse@email.com" id="email" name="email"
            ...
            <div class="form_row url" style="float:left; margin-right: 15px;">
                ...
                <input type="password" required="required" placeholder="<?= i("Nouveau mot de passe"); ?>" id="pass"
                    name="pass" style="width: 275px;" class="input validate[required] tipRight" value="">
            </div>
            ...
            <div class="form_row url" style="float:left; margin-right: 15px;">
                ...
                <input type="password" required="required" placeholder="<?= i("Retaper le mot de passe"); ?>" id="pass2"
                    name="pass2" style="width: 275px;" class="input validate[required] tipRight" value="">
            </div>
